...
try {
  ...
  $stmt->execute([
    ...
    ':middle_name' => isset($input['middle_name']) ? ucwords(strtolower($input['middle_name'])) : null,
    ':age' => (int)$input['age'],
    ':gender' => $input['gender'],
    ':address' => ucwords(strtolower($input['address'])),
    ':barangay' => ucwords(strtolower($input['barangay'])),
    ':contact_number' => $input['contact_number'] ?? null,
    ':occupation' => isset($input['occupation']) ? ucwords(strtolower($input['occupation'])) : null,
